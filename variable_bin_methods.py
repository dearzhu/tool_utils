...
#     for i in cont_name:
#         dict_cont_bin[i], gain_value_save, gain_rate_save = cont_var_bin(data_train[i], data_train.target, method=1,
#                                                                          mmin=4, mmax=10,
...
#     for i in disc_name:
#         dict_disc_bin[i], gain_value_save, gain_rate_save, del_key_1 = disc_var_bin(data_train[i], data_train.target,
#                                                                                     method=1, mmin=3,
#                                                                                     mmax=8, stop_limit=0.1,
#                                                                                     bin_min_num=5)
#         if len(del_key_1) > 0:
